...
namespace SharpMap.Layers
{
    ...
    public delegate void MapNewTileAvaliabledHandler(ITileAsyncLayer sender, Envelope bbox, byte[] bm, int sourceWidth, int sourceHeight, ImageAttributes imageAttributes);
