...
namespace SharpMap.Rendering.Symbolizer
{
    ...
    public abstract class PolygonSymbolizer : BaseSymbolizer, IPolygonSymbolizer
    {
        ...
        protected abstract void OnRenderInternal(IMapViewPort map, IPolygon polygon, Graphics g);
        ...
        public override void Begin(Graphics g, IMapViewPort map, int aproximateNumberOfGeometries)
        {
