...
namespace SharpMap.Rendering.Symbolizer
{
    ...
    public abstract class LineSymbolizer : BaseSymbolizer, ILineSymbolizer
    {
        ...
        public void Render(IMapViewPort map, ILineal lineal, Graphics g)
        {
        ...
        protected abstract void OnRenderInternal(IMapViewPort map, ILineString lineString, Graphics graphics);
        ...
        /// <param name="map">The map</param>
        public override void Symbolize(Graphics g, IMapViewPort map)
        {
        }
