...
namespace SharpMap.Rendering.Symbolizer
{
    ...
    public class GeometrySymbolizer : ISymbolizer<IGeometry>
    {
        ...
        public void Begin(Graphics g, IMapViewPort map, int aproximateNumberOfGeometries)
        {
        ...
        /// <param name="g">The graphics object</param>
        /// <param name="map">The map</param>
        public void Symbolize(Graphics g, IMapViewPort map)
        {
        ...
        /// <param name="g">The graphics object</param>
        /// <param name="map">The map</param>
        public void End(Graphics g, IMapViewPort map)
        {
