...
<asp:Content ID="cssContent" ContentPlaceHolderID="CustomCssContent" runat="server">
    ...
    <link rel="stylesheet" href="<%=this.Url.Content("~/theme/geosilk/geosilk.css?v=1")%>" />
</asp:Content>
<asp:Content ID="jsContent" ContentPlaceHolderID="CustomJsContent" runat="server">
    <script type="text/javascript" src="<%=this.Url.Content("~/lib/OpenLayersEditor.js?v=1")%>"></script>
