...
<asp:Content ID="jsContent" ContentPlaceHolderID="CustomJsContent" runat="server">
    ...
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/ll/TileLayer.TileJSON.js?v=1")%>"></script>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/script_tc.js?v=1")%>"></script>
</asp:Content>
