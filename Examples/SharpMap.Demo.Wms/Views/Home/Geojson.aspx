...
<asp:Content ID="jsContent" ContentPlaceHolderID="CustomJsContent" runat="server">
    ...
    <script type="text/javascript" src="<%=this.Url.Content("~/Scripts/ol/SelectFeatureEx.js?v=1")%>"></script>
    <script type="text/javascript" src="<%=this.Url.Content("~/Scripts/ol/LoadingPanel.js?v=1")%>"></script>
    <script type="text/javascript" src="<%=this.Url.Content("~/Scripts/ol/Resources.js?v=1")%>"></script>
    <script type="text/javascript" src="<%=this.Url.Content("~/Scripts/rx.js?v=1")%>"></script>
    <script type="text/javascript" src="<%=this.Url.Content("~/Scripts/rx.OpenLayers.js?v=1")%>"></script>
    <script type="text/javascript" src="<%=this.Url.Content("~/Scripts/script_geojs.js?v=1")%>"></script>
</asp:Content>
